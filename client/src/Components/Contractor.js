...
const ContractorPage = () => {
  ...
  return (
    <>
  <div className="walletAddress"><h3>Connect Contractor's Wallet</h3></div>
  <div className="buttonContainer"><button onClick={connectWalletHandler}>Connect</button></div>
      <div className="accountDisplay">
        <h3>Address of Contractor Wallet : {defaultAccount}</h3>
      </div>
      <div className="balanceDisplay">
        <h3>Balance of Contractor Wallet : {userBalance} ETH</h3>
      </div>
      <div className="allocateFunds">   {/*allocate funds section starts*/}
        <h4>{"Allocate Funds for Raw-Material Supplier "}</h4>
        <input
          type="text"
      ...
      </div>   {/*allocate funds section ends*/}
      <div className="transferFunds">    {/*tranfer funds section starts*/}
        <h4>{"Transfer Funds to Raw-Material Supplier"}</h4>
        <input
          type="text"
          placeholder="To Address"
          value={toAddress}
      ...
      </div>                               {/*tranfer funds section ends*/}
      <div className="allocateFunds">
        <h4>{"Allocate Funds for Labour Supplier"}</h4>
        <input
          type="text"
          placeholder="From Address"
          value={fromAddress}
      ...
      <div className="transferFunds">    {/*tranfer funds section starts*/}
        <h4>{"Transfer Funds to Labour Supplier"}</h4>
        <input
          type="text"
          placeholder="To Address"
          value={toAddress}

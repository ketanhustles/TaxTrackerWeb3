...
const HealthCareSectorPage = () => {
    ...
    return (
      <>
    <div className="walletAddress"><h3>Connect HealthCare Ministry Wallet</h3></div>
    <div className="buttonContainer"><button onClick={connectWalletHandler}>Connect</button></div>
        <div className="accountDisplay">
          <h3>Address of HealthCare Ministry's Wallet : {defaultAccount}</h3>
        </div>
        <div className="balanceDisplay">
          <h3>Balance of HealthCare Ministry's Wallet : {userBalance} ETH</h3>
        </div>

...
const MaterialSupplierPage = () => {
  ...
  return (
    <>
      <div className="walletAddress"><h3>Connect Material Supplier's Wallet</h3></div>
      <div className="buttonContainer"><button onClick={connectWalletHandler}>Connect</button></div>
      <div className="accountDisplay">
        <h3>Address of Material Supplier's Wallet : {defaultAccount}</h3>
      </div>
      <div className="balanceDisplay">
        <h3>Balance of Material Supplier's Wallet : {userBalance} ETH</h3>
      </div>

...
const RoadTransportSectorPage = () => {
    ...
    return (
      <>
    <div className="walletAddress"><h3>Connect Road & Transport Ministry Wallet</h3></div>
        <div className="buttonContainer"><button onClick={connectWalletHandler}>Connect</button></div>
        <div className="accountDisplay">
          <h3>Address of Road & Transport Ministry's Wallet : {defaultAccount}</h3>
        </div>
        <div className="balanceDisplay">
          <h3>Balance of Road & Transport Ministry's Wallet : {userBalance} ETH</h3>
        </div>
        <div className="allocateFunds">
          <h4>{"Allocate Funds to Contractor"}</h4>
          <input
            type="text"
        ...
        <div className="transferFunds">
          <h4>{"Transfer Funds to Contractor"}</h4>
          <input
            type="text"
            placeholder="To Address"
            value={toAddress}
